...
async function saveActivityData(user_id) {
  try {
    ...
    if (isExistingRecord) {
      ...
      const differenceOfSteps = (activityData.steps - todayRecord.steps) > 0 ? (activityData.steps - todayRecord.steps) : 0;
      const differenceOfDistance = (activityData.distance - todayRecord.distance) > 0 ? (activityData.distance - todayRecord.distance) : 0;
      const differenceOfCalories = (activityData.calories - todayRecord.calories) > 0 ? (activityData.calories - todayRecord.calories) : 0;
